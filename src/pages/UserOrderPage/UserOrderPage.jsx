                  ...
                  return (
                    <WrapperItemOrder key={order?._id}>
                      <WrapperStatus>
                        ...
                        <div>
                          <span style={{ color: 'rgb(255, 66, 78)' }}>Delivery: </span>{`${order.isDelivered ? 'Delivered' : 'Not Delivered'}`}
                        </div>
                        <div>
                          <span style={{ color: 'rgb(255, 66, 78)' }}>Payment: </span>{`${order.isPaid ? 'Paid' : 'Unpaid'}`}
                      ...
                      <WrapperFooterItem>
                        <div>
                          <span style={{ color: 'rgb(255, 66, 78)' }}>Total Amount: </span>
                          <span
